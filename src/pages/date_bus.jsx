        ...
        <div class="stats-container">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <p class="stat-label">Sub-Urbaine</p>
                </div>
            </div>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">TSELATRA</td>
                        <td>178</td>
                        <td class="">ANTANANARIVO</td>
                        <td>Andraisoro - Anosy</td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">KOFIATRA</td>
                        <td>Ligne E</td>
                        <td>ANTANANARIVO</td>
                        <td>Fasika - Andravoangy</td>
