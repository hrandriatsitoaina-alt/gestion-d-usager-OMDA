        ...
        try {
          ...
          if (allUsagersResponse.data.success && allUsagersResponse.data.usagers) {
            usagersData = allUsagersResponse.data.usagers.filter(
              (u) => u.type_usager === 'media' || u.type === 'media' || u.type_usager === 'tele_radio'
            );
          }
        } catch (err) {
      ...
      <main className="contenu-grandsurface">
        {notification && (
          <div className={`notif ${notification.type}`}>
            <span>{notification.type === 'success' ? <Check size={16} /> : notification.type === 'info' ? <Signal size={16} /> : <X size={16} />}</span>
        ...
        <div className="grandsurface-container">
          ...
          <div className="page-header">
            <div className="header-left">
              <h1>
                <Tv className="header-icon" size={28} />
                Télé / Radio : <span>Suivi des paiements</span>
              </h1>
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>
                <Tv size={18} /> {selectedUsager.denomination || selectedUsager.nom || 'Média'}
              </h3>
            ...
            <div className="modal-body">
              <div className="modal-section">
                ...
                <div className="modal-row">
                  <span>Fréquence</span>
                  <strong>{selectedUsager.frequence || '-'}</strong>
                </div>
                <div className="modal-row">
                  <span>Canal</span>
                  <strong>{selectedUsager.canal || selectedUsager.type_media || '-'}</strong>
                </div>
                <div className="modal-row">
                  <span>Type Média</span>
                  <strong>{selectedUsager.type_media || selectedUsager.categorie || '-'}</strong>
                </div>
              </div>
              <div className="modal-section">
                <h4>
