      ...
      <main className="contenu-grandsurface">
        {notification && (
          <div className={`notif ${notification.type}`}>
            <span>{notification.type === 'success' ? <Check size={16} /> : notification.type === 'info' ? <Hotel size={16} /> : <X size={16} />}</span>
          ...
          <div className="page-header">
            <div className="header-left">
              <h1>
                ...
                Hôtels : <span>Suivi des paiements</span>
              </h1>
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>
                <Hotel size={18} /> {selectedUsager.denomination || selectedUsager.nom || 'Hôtel'}
              </h3>
