...
// EXPORTATION CORRIGÉE: generateNightPDF (au lieu de generateNightClubPDF)
export const generateNightPDF = (usager, paymentDetails) => {
  try {
    ...
    // INFORMATIONS SPECIFIQUES NIGHT CLUB
    ...
    console.log('Données extraites:', { demandeur, denomination, representantNom, jaugeMax, horaires, montantMensuel, totalAnnuel });
    ...
    doc.setFontSize(13);
    const titre2 = 'FICHE DE RENSEIGNEMENTS – NIGHT CLUB';
    ...
    doc.setFont('helvetica', 'bold');
    doc.setFontSize(12);
    const section3 = '3) RENSEIGNEMENTS SUR L\'ETABLISSEMENT :';
